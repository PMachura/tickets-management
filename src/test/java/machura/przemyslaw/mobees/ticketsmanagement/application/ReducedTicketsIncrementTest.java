...
public class ReducedTicketsIncrementTest {
    ...
    public void shouldCreateQuarterlySalesPeriod(Utils.SalesPeriodsTestCase testCase) {
        ...
        ReducedTicketsIncrement ticketsAdjuster = ReducedTicketsIncrement.create(timeProvider, testCase.requestReducedTicketAdjustment).get();
    ...
    private static List<Utils.SalesPeriodsTestCase> salesPeriodsReducedTicketIncrementTestCases() {
        return List.of(
                ...
                Utils.SalesPeriodsTestCase.builder()
                        ...
                        .adjustedReducedTickets(Arrays.asList(0, 0, 0, 0, 0, 0, 44, 44, 44, 44, 44, 44, 43))
                        .build(),
                ...
                Utils.SalesPeriodsTestCase.builder()
                        ...
                        .reducedTickets(Arrays.asList(0, 0, 0, 0, 0, 0, 43, 43, 43, 43, 43, 43, 42))
                        .adjustedReducedTickets(Arrays.asList(0, 0, 0, 0, 0, 0, 50, 50, 50, 50, 50, 50, 50))
                        .build()
        );
    }
}
